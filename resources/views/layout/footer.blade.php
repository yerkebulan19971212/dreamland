...
{{--                    <a href="/" style="color:#ffffff;font-size:20px;font-weight:600;"><img src="https://static.tildacdn.com/tild3330-3162-4532-a265-616562633031/-/empty/Artboard.png" data-original="https://static.tildacdn.com/tild3330-3162-4532-a265-616562633031/Artboard.png" class="t420__logo t-img" imgfield="img" alt="Меню"></a>--}}
{{--                    <div class="t-sociallinks">--}}
{{--                        <div class="t-sociallinks__wrapper">--}}
{{--                            <div class="t-sociallinks__item">--}}
{{--                                <a href="https://www.facebook.com/infostudyworld/" target="_blank">--}}
...
{{--                            </div>--}}
{{--                            <div class="t-sociallinks__item">--}}
{{--                                <a href="https://vk.com/infostudy" target="_blank">--}}
{{--                                    <svg class="t-sociallinks__svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve">--}}
{{--                        <desc>VK</desc>--}}
...
{{--                            </div>--}}
{{--                            <div class="t-sociallinks__item">--}}
{{--                                <a href="https://www.youtube.com/channel/UChE0PN31fPGL3i27M8_QmzQ" target="_blank">--}}
{{--                                    <svg class="t-sociallinks__svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve">--}}
{{--                        <desc>Youtube</desc>--}}
...
{{--                            </div>--}}
{{--                            <div class="t-sociallinks__item">--}}
{{--                                <a href="https://www.instagram.com/info_study/" target="_blank">--}}
...
{{--                    </div>--}}
                ...
                <div>
                    ...
                    <div class="t420__col t-col t-col_3">
                        <div class="t420__title t-name t-name_xs t420__title_uppercase" field="title3" style="color: #ffffff;">Контакты</div>
                        <div class="t420__descr t-descr t-descr_xxs" field="descr3" style="color: #ebebeb;color:#ebebeb;"><span data-replace-key='phone'>+7 707 951 93 63</span>
                            <br />info@dreamland.kz
                            <br />
                            <br />74 Madison ave. Richmond Hill, Toronto,
                            <br />Ontario, Canada
                            <br />
                        </div>
                    </div>
