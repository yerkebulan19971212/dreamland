...
window.crl8.EventBus.dispatchEvent('initializeCuralatePixel', { pixelId: 117320, useDebug: false });
window.crl8.EventBus.dispatchEvent('siteReady', { name: 'eflanguage-6rlm8x' });
}